...
from Agents.NARPortfolioDataAgent import PortfolioDataAgent
from Agents.NARScenarioInputAgent import ScenarioInputAgent
from Agents.NARSignalAnalysisAgent import SignalAnalysisAgent
from Agents.NARTaxRulesAgent import TaxRulesAgent
    ...
    try:
        ...
        while True:
            try:
                ...
                print(f"Error while adding stock data: {e}")
