...
def validate_one_epoch(loader, min_val_loss):
    ...
    if (avg_loss_across_batches < min_val_loss):
        ...
        torch.save(model.state_dict(), 'LSTM_model_timeSeries.ckpt')
        print('Saving model...')
...
def validate_one_epoch(model, val_loader, min_val_loss, loss_function):
    ...
    if (avg_loss_across_batches < min_val_loss):
        ...
        # Save the model parameters
        torch.save(model.state_dict(), 'BiLSTM_model_timeSeries.ckpt')
        print('Saving model...')
...
def validate_one_epoch(model, val_loader, min_val_loss, loss_function):
    ...
    if (avg_loss_across_batches < min_val_loss):
        ...
        # Save the model parameters
        torch.save(model.state_dict(), 'RNN_model_timeSeries.ckpt')
        print('Saving model...')
...
def validate_one_epoch(model, val_loader, min_val_loss, loss_function):
    ...
    if (avg_loss_across_batches < min_val_loss):
        ...
        # Save the model parameters
        torch.save(model.state_dict(), 'Ensemble_model_timeSeries.ckpt')
        print('Saving model...')
